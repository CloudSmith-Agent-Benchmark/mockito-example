...
public class EmployeeManagerAlternativeTest {
        ...
        public void testPayEmployeesWhenNoEmployeesArePresent() {
                when(employeeRepository.findAll())
                        .thenReturn(asList(new Employee("1", 1000))); // Changed to return one employee
                assertThat(employeeManager.payEmployees()).isZero(); // This will fail as it should return 1
        }

        @Test
        public void testPayEmployeesWhenOneEmployeeIsPresent() {
                assertThat(employeeManager.payEmployees()).isEqualTo(1);
                verify(bankService).pay("1", 1000); // This will fail as amount is 2000
        }
